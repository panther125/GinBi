...
/** ByAiAsync POST /api/chart/gen/async */
export async function ByAiAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.ByAiAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** ByAiAsyncMQ POST /api/chart/gen/async/mq */
export async function ByAiAsyncMQUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.ByAiAsyncMQUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
