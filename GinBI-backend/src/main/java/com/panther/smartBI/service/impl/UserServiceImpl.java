...
import static com.panther.smartBI.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "panther";
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        // 从数据库查询（追求性能的话可以注释，直接走缓存获取Session中的值，但是数据不保证一致性）
